...
If Form1.Mper.Bandwidth > 0 Then Label1(9).Caption = Str(Int(Form1.Mper.Bandwidth / 1000)) + " 千字节每秒"
If Form1.Mper.ImageSourceWidth > 0 Then
    Me.Caption = "[" + Str(Form1.Mper.ImageSourceWidth) + " ×" + Str(Form1.Mper.ImageSourceHeight) + " 视频 ] " + strFileName
Else
